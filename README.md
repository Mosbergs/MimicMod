...
- **Future-Proof Design**
  - Expansion hooks for biome-specific variants and the **Ancient Mimic Boss**.
  - JSON schema validation for loot tables, advancements, and configs.
  - Cross-version compatibility helpers for smooth updates.
...
3. Install [GeckoLib](https://modrinth.com/mod/geckolib) (required for animations).
4. Place the Mimic Mod `.jar` file into your `mods` folder.

---

## 🎮 Gameplay Notes

- Mimics disguise themselves as **regular chests** until approached.
- Defeating a mimic may yield:
  - Rare loot (configurable).
  - Cosmetic drops (skins, trinkets).
  - Lore fragments for the codex.
- Spawn rates and difficulty scale with player progression.
...
- `cosmetic_drops`: Toggle optional rewards.

Schema validation ensures configs remain error-free.
...
- Ancient Mimic Boss encounter.
- Biome-specific mimic variants.
- Decorative mimic blocks for builders.
- Community-driven expansion hooks.
